...
<div class="login-form">
    <a href="{{url('/siteadmin/technologies')}}">Go back</a>
    <div class="">
        ...
        <form action="" method="POST">
            ...
            <textarea type="text" name="technologies_main_content" class="form-control col-12 pb-20" id="" style="margin-bottom: 30px" placeholder="technoloies main content here"></textarea>
