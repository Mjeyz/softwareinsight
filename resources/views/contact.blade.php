...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="offcanvas offcanvas-end sidebar-nav" tabindex="-1" id="offcanvasRight">
				<div class="offcanvas-header">
				    <div class="logo"><a href="index.html"><img src="{{url('images/logo/vCamp_01.png') }}" alt="" width="127"></a></div>
			  	...
			  	<div><a href="sign-in.html" class="theme-btn-one ripple-btn d-block"><img src="{{url('images/icon/icon_22.svg') }}" alt="" class="me-2 ms-0"> login</a></div>
					...
					<div class="d-flex align-items-center justify-content-between">
							                ...
							                <li class="pb-20">
							                	<div class="row gx-2">
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index.html" class="d-block img-meta"><img src="{{url('images/nav-img/home02.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index.html" class="dropdown-item"><span>Creative Agency</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-2.html" class="d-block img-meta"><img src="{{url('images/nav-img/home01.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-2.html" class="dropdown-item"><span>Business</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-3.html" class="d-block img-meta"><img src="{{url('images/nav-img/home03.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-3.html" class="dropdown-item"><span>Agency Minimal</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-4.html" class="d-block img-meta"><img src="{{url('images/nav-img/home04.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-4.html" class="dropdown-item"><span>Service Provider</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-5.html" class="d-block img-meta"><img src="{{url('images/nav-img/home05.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-5.html" class="dropdown-item"><span>Startup</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-6.html" class="d-block img-meta"><img src="{{url('images/nav-img/home06.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-6.html" class="dropdown-item"><span>Design Studio Light</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-7.html" class="d-block img-meta"><img src="{{url('images/nav-img/home07.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-7.html" class="dropdown-item"><span>Design Studio Dark</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-8.html" class="d-block img-meta"><img src="{{url('images/nav-img/home08.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-8.html" class="dropdown-item"><span>Shop Standard</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-9.html" class="d-block img-meta"><img src="{{url('images/nav-img/home09.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-9.html" class="dropdown-item"><span>Shop Creative</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-10.html" class="d-block img-meta"><img src="{{url('images/nav-img/home10.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-10.html" class="dropdown-item"><span>Startup Agency</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-11.html" class="d-block img-meta"><img src="{{url('images/nav-img/home11.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-11.html" class="dropdown-item"><span>Consulting Agency</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-12.html" class="d-block img-meta"><img src="{{url('images/nav-img/home13.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-12.html" class="dropdown-item"><span>Photographer Portfolio</span><i class="tag">New</i></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-13.html" class="d-block img-meta"><img src="{{url('images/nav-img/home14.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-13.html" class="dropdown-item"><span>Designer Portfolio</span><i class="tag">New</i></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-14.html" class="d-block img-meta"><img src="{{url('images/nav-img/home15.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-14.html" class="dropdown-item"><span>Marketing Agency</span><i class="tag">New</i></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="index-15.html" class="d-block img-meta"><img src="{{url('images/nav-img/home18.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="index-15.html" class="dropdown-item"><span>Design Agency Portfolio</span><i class="tag">New</i></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<a href="coming-soon.html" class="d-block img-meta"><img src="{{url('images/nav-img/home12.jpg') }}" alt="" class="tran4s"></a>
							                			<a href="coming-soon.html" class="dropdown-item"><span>Coming Soon</span></a>
							                		</div>
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<div class="d-block img-meta">
							                				<img src="{{url('images/nav-img/home16.jpg') }}" alt="" class="tran4s">
							                		...
							                		<div class="col-lg-2 mt-15 border-0 text-center home-sub-menu">
							                			<div class="d-block img-meta">
							                				<img src="{{url('images/nav-img/home17.jpg') }}" alt="" class="tran4s">
							                				<div class="cs d-flex align-items-center justify-content-center"><span>Coming Soon</span></div>
							                			</div>
						...
						<div class="right-widget d-flex align-items-center">
							<a href="sign-in.html" class="d-flex align-items-center login-btn">
								<img src="{{url('images/icon/icon_01.svg') }}" alt="">
								<span>login</span>
							</a>
					...
					<div class="row">
						<div class="col-md-4">
							<div class="address-block-one text-center mb-40">
								<div class="icon d-flex align-items-center justify-content-center m-auto"><img src="{{url('images/icon/icon_17.svg') }}" alt=""></div>
						...
						<div class="col-md-4">
							<div class="address-block-one text-center mb-40">
								<div class="icon d-flex align-items-center justify-content-center m-auto"><img src="{{url('images/icon/icon_18.svg') }}" alt=""></div>
						...
						<div class="col-md-4">
							<div class="address-block-one text-center mb-40">
								<div class="icon d-flex align-items-center justify-content-center m-auto"><img src="{{url('images/icon/icon_19.svg') }}" alt=""></div>
					...
					<div class="box-layout">
						<div class="mapouter">
							<div class="gmap_canvas">
								<iframe class="gmap_iframe" src="{{url('https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=dhaka collage&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed') }}"></iframe>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="tsi-footer-one">
				<div class="bg-wrapper bg-white">
										...
										<div class="col-md-6">
											<div class="subscribe-form">
												<form action="#">
													...
													<button class="ripple-btn">Join <img src="{{url('images/icon/icon_20.svg" alt="" class="ms-2 d-inline-block') }}"></button>
												</form>
					...
					<img src="{{url('images/assets/ils_03.svg') }}" alt="" class="shapes illustration">
				</div> <!-- /.bg-wrapper -->
				<div class="container">
					<div class="row">
						<div class="col-xxl-11 m-auto">
		...
		<!-- AOS js -->
		<script src="{{url('vendor/aos-next/dist/aos.js') }}"></script>
		<!-- Slick Slider -->
		<script src="{{url('vendor/slick/slick.min.j') }}s"></script>
		<!-- js Counter -->
		<script src="{{url('vendor/jquery.counterup.min.js') }}"></script>
		<script src="{{url('vendor/jquery.waypoints.min.js') }}"></script>
		<!-- Fancybox -->
		<script src="{{url('vendor/fancybox/dist/jquery.fancybox.min.js') }}"></script>
		<!-- validator js -->
    	<script src="{{url('vendor/validator.js') }}"></script>
    	<!-- Telephone Select -->
		<script src="{{url('vendor/intl-tel/build/js/intlTelInput.min.js') }}"></script>
		<!-- Select js -->
    	<script src="{{url('vendor/selectize.js/selectize.min.js') }}"></script>
